                                            ...
                                            <div class="table-search-row mb-1">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto">
                                                        <input type="text" name="nm_pt" class="form-control" placeholder="Masukkan NAMA PT">
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto">
                                                        <input type="text" name="nm_prodi" class="form-control" placeholder="Masukkan NAMA PRODI">
                                                    </div>
                                                    <div class="col-md-1"></div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto">
                                                        <select class="custom-select mb-1" id="nm_jabatan" name="nm_jabatan">
                                                            <option selected value="">Pilih JAFUNG</option>
                                                            <option value="Tenaga Pengajar">Tenaga Pengajar</option>
                                                            <option value="Asisten Ahli">Asisten Ahli</option>
                                                            <option value="Lektor">Lektor</option>
                                                            <option value="Lekor Kepala">Lekor Kepala</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto">
                                                        <input type="text" name="nm_stat_aktif" class="form-control" placeholder="Masukkan Status Keaktifan">
                                                    </div>
                                                    <div class="col-md-1"></div>
                                                </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#dataTables').DataTable({
                ...
                ajax: {
                    url: "<?= base_url('beranda/beranda/data'); ?>",
                    type: "POST"
                },
                order: [
                    [3, "asc"]
