        ...
        <div class="col-md-12 col-sm-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title" id="heading-buttons1">Data Plotting Fasilitator</h4>
              <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
              <div class="heading-elements">
                <button type="button" class="btn btn-primary waves-effect waves-light mr-1" data-toggle="modal" data-plotting-fasilitator="false" data-target="#plotting-fasilitator">Plotting Fasilitator</button>
              </div>
            </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel4">PLOTTING FASILITATOR
          <br>
          <span class="badge badge-primary font-medium-1"><?= $periode_aktif->keterangan ?></span>
        </h4>
      ...
      <input type="hidden" name="periode" value="<?= $periode_aktif->kode ?>">
