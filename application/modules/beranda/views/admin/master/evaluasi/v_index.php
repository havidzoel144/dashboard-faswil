        ...
        <div class="col-lg-8 col-md-6 col-sm-12 mx-auto">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title" id="heading-buttons1">Evaluasi 360</h4>
            </div>
                      ...
                      ?>
                          <tr class="<?= $warna_baris ?>">
                            ...
                            <td class="text-center" style="width: 8%;">
                              <a href="<?= base_url('admin/evaluasi-360/detail/') . safe_url_encrypt($data['kode']) ?>">
                                <button class="btn btn-primary btn-sm" type="button" data-toggle="tooltip" title="Lihat Detail Periode">
                                  <i class="la la-eye"></i>
                                  Pilih
                                </button>
                              </a>
