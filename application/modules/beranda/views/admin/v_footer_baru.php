...
<script src="<?= base_url() ?>app-assets/vendors/js/extensions/transition.js"></script>
<script src="<?= base_url() ?>app-assets/vendors/js/extensions/zoom.min.js"></script>
<!-- END: Page Vendor JS-->
...
<script src="<?= base_url() ?>app-assets/js/scripts/modal/components-modal.js"></script>
...
<?php if ($this->session->flashdata('error_validation')) :
    $errors = $this->session->flashdata('error_validation');
?>
    <script>
        Swal.fire({
            icon: 'error',
