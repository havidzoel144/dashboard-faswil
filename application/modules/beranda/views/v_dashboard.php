...
<style>
    ...
    .form-check {
        flex: 1 1 30%;
        /* Menyusun checkbox dengan lebar sekitar 30% per item untuk 3 item dalam satu baris */
        margin-bottom: 10px;
    }
                                        ...
                                        <div class="form-body">
                                            <div class="table-search-row mb-1">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto">
                                                        <select class="select2 form-control select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" name="status_pt" id="status_pt">
                                                            <option value="">Silakan pilih Status PT</option>
                                                            <?php foreach ($status_pt as $item) { ?>
                                                                <option value="<?= $item['nm_status'] ?>"><?= $item['nm_status'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <!-- <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto form-check-container">
                                                        <?php foreach ($akreditasi_pt as $akre) { ?>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" id="akreditasi_pt_<?= $akre['akreditasi_pt'] ?>" name="akreditasi_pt[]" value="<?= $akre['akreditasi_pt'] == "(-)" ? 'kosong' : $akre['akreditasi_pt'] ?>">
                                                                <label class="form-check-label" for="akreditasi_pt_<?= $akre['akreditasi_pt'] ?>">
                                                                    <?= $akre['akreditasi_pt'] ?>
                                                                </label>
                                                            </div>
                                                        <?php } ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto form-check-container">
                                                        ...
                                                        <!-- <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="akreditasi_pt_Unggul" name="akreditasi_pt[]" value="Unggul">
                                                            <label class="form-check-label" for="akreditasi_pt_Unggul">
                                                                Unggul
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="akreditasi_pt_Baik Sekali" name="akreditasi_pt[]" value="Baik Sekali">
                                                            <label class="form-check-label" for="akreditasi_pt_Baik Sekali">
                                                                Baik Sekali
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="akreditasi_pt_Baik" name="akreditasi_pt[]" value="Baik">
                                                            <label class="form-check-label" for="akreditasi_pt_Baik">
                                                                Baik
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="akreditasi_pt_A" name="akreditasi_pt[]" value="A">
                                                            <label class="form-check-label" for="akreditasi_pt_A">
                                                                A
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="akreditasi_pt_B" name="akreditasi_pt[]" value="B">
                                                            <label class="form-check-label" for="akreditasi_pt_B">
                                                                B
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="akreditasi_pt_" name="akreditasi_pt[]" value="">
                                                            <label class="form-check-label" for="akreditasi_pt_">
                                                                (-)
                                                            </label>
                                                        </div> -->

                                                        <select class="select2 form-control select2-hidden-accessible" multiple="" data-select2-id="1" tabindex="-1" aria-hidden="true" name="akreditasi_pt" id="akreditasi_pt">
                                                            <?php foreach ($akreditasi_pt as $item) { ?>
                                                                <option value="<?= $item['akreditasi_pt'] == '' ? 'kosong' : $item['akreditasi_pt'] ?>"><?= $item['akreditasi_pt'] == '' ? '(-)' : $item['akreditasi_pt'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput1">Tanggal Akhir Akreditasi</label>
...
<script src="<?= base_url() ?>assets/js_tampil/data_pt.js"></script>
