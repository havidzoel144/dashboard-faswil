                ...
                <div class="container col-xl-11">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <b><i>* Data Terkini dapat diakses melalui: PDDikti (<a href="https://pddikti.kemdiktisaintek.go.id/" target="_blank" rel="noopener noreferrer">pddikti.kemdikbud.go.id</a>)</i></b>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="form-body">
                                            <div class="table-search-row mb-1">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto">
                                                        <select class="select2 form-control select2-hidden-accessible" multiple="" data-select2-id="12" tabindex="-1" aria-hidden="true" name="nm_jabatan[]" id="nm_jabatan">
                                                            <?php foreach ($nm_jabatan as $item) { ?>
                                                                <option value="<?= $item['nm_jabatan'] == '' ? 'kosong' : $item['nm_jabatan'] ?>"><?= $item['nm_jabatan'] == '' ? '(-)' : $item['nm_jabatan'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-1"></div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 mx-auto">
                                                        <select class="select2 form-control select2-hidden-accessible" multiple="" data-select2-id="1" tabindex="-1" aria-hidden="true" name="nm_stat_aktif[]" id="nm_stat_aktif">
                                                            <?php foreach ($nm_stat_aktif as $item) { ?>
                                                                <option value="<?= $item['nm_stat_aktif'] ?>"><?= $item['nm_stat_aktif'] ?></option>
                                                            <?php } ?>
                                                        </select>
...
<script src="<?= base_url() ?>assets/js_tampil/data_dosen.js"></script>
