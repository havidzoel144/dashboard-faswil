...
$route['admin/kelola-kegiatan/get/(:num)'] ='beranda/kegiatan/getKegiatan/$1';
$route['admin/kelola-kegiatan/ubah'] = 'beranda/kegiatan/ubahKegiatan';
$route['admin/kelola-kegiatan/hapus'] = 'beranda/kegiatan/hapusKegiatan';
$route['admin/kelola-kegiatan/update-status'] = 'beranda/kegiatan/updateStatus';
$route['admin/kelola-kegiatan/update-unggulan'] = 'beranda/kegiatan/updateUnggulan';
$route['admin/kelola-kegiatan/update-dashboard'] = 'beranda/kegiatan/updateTampilDashboard';
$route['admin/kelola-kegiatan/detail/(:any)'] = 'beranda/kegiatan/detail/$1';
$route['admin/kelola-kegiatan/loadMore'] = 'beranda/kegiatan/loadMore';
$route['admin/kegiatan'] = 'beranda/kegiatan/semua';
